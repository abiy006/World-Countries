...
# 📖 [World-contries PRJECT] <a name="about-project"></a>

**[Abiy Capstone Three]** This is a World-contries project created during my Microverse course. 
...
```
  git clone https://github.com/abiy006/World-contries.git
```
### Install
...
Feel free to check the [issues page](https://github.com/abiy006/World-contries/issues).
